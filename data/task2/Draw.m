close all;
data1 = matfile("target1.mat");
angles1 = data1.target1;
data2 = matfile("target2.mat");
angles2 = data2.target2;
data3 = matfile("target3.mat");
angles3 = data3.target3;
...
title('Target (-10, 10, 10) ','Interpreter','latex') 
